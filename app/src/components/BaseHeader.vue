<template>
  <header class="px-4 md:px-12 py-20 border-b border-white-100 text-center relative">
    ...
    <div v-if="formattedOwner">
      <span class="text-white-400 mr-4">by</span>
      <a
        v-if="owner"
        class="link mr-4"
        ...
        >{{ formattedOwner }}</a
      >
      <span v-if="formattedLastUpdated" class="italic text-white-400">{{ formattedLastUpdated }}</span>
    </div>
